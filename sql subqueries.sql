/* ================================================================================
STEP 1: DATABASE SETUP (Datasets)
================================================================================
*/
...
/* ================================================================================
STEP 2: ASSIGNMENT SOLUTIONS (Subqueries)
================================================================================
*/
...
SELECT name FROM Employees 
WHERE emp_id IN (SELECT emp_id FROM Sales WHERE sale_amount > (SELECT AVG(sale_amount) FROM Sales));
...
WHERE emp_id IN (SELECT emp_id FROM Employees WHERE salary > (SELECT AVG(salary) FROM Employees));
...
WHERE emp_id = (
    SELECT emp_id FROM Sales 
    ORDER BY sale_amount DESC LIMIT 1 OFFSET 1
);
